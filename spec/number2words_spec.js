...
function libDescription(){
  ...
  function cornerCasesDescription(){
    ...
    function spec3(){
      expect(converterToWords.convert(121021)).toEqual('ciento veintiún mil veintiuno');
      expect(converterToWords.convert(21021)).toEqual('veintiún mil veintiuno');
      expect(converterToWords.convert(31021)).toEqual('treinta y un mil veintiuno');
      expect(converterToWords.convert(41021)).toEqual('cuarenta y un mil veintiuno');
      //http://hispanoteca.eu/Foro-preguntas/ARCHIVO-Foro/Numerales%20uno-una%20-%20formas%20apocopadas.htm
      expect(converterToWords.convert(201000)).toEqual('doscientos un mil');
  ...
  function description5(){
    ...
    it('2. Debería convertir números entre 100 y 900 de dos sílabas',spec2);
    function spec2(){
  ...
  function description6(){
    it('1. Debería convertir los múltiplos de 1000 hasta el 900.000 de 1 o dos sílabas',spec1);
    function spec1(){
    ...
    it('2. Debería convertir números entre 102.000 y 990.000 de tres sílabas',spec2);
    function spec2(){
    ...
    it('3. Debería convertir números entre 102.001 y 990.900 de cuatro sílabas',spec3);
    function spec3(){
    ...
    it('4. Debería convertir números entre 102.031 y 990.990 de cinco sílabas',spec4);
    function spec4(){
    ...
    it('5. Debería convertir números entre 102.131 y 990.999 de seis sílabas',spec5);
    function spec5(){
    ...
    it('6. Debería convertir números entre 132.131 y 999.999 de siete sílabas',spec6);
    function spec6(){
